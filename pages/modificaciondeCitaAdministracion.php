...
//mysql_select_db('octavio') or die('La base de datos no existe');
 ...
 //$Id =$_GET['Id'];
 $sql = "UPDATE cita2 SET nombre = '$nombre', email = '$email', telefono = '$telefono', ciudad = '$ciudad', edad = '$edad', sexo = '$sexo', fecha_cita = '$fecha_cita', hora_cita = '$hora_cita' WHERE clave = $Id";
?>
    ...
    <form action = "modificaciondeCita.php" method = "post">
      <table class = "table">
        ...
        <?php if($resultado= mysqli_query($conexion,$sql)){ ?>
          ...
          <tr>
            <td>La cita con clave <?php echo $Id; ?> ha sido modificada;</td>
          </tr>
          <tr>
        ...
        <?php }else{ ?>
          ...
          <tr>
            <td>se presento un error al intentar modificar la cita con clave <?php echo $Id; ?>.</td>
          </tr>
          <tr>
            <td colspan = "1" style = "text-align: center">
              <a href="consulta.php?Id=<?php echo $Id; ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style = "background-color:#0000ff;">Regresar</a>
